...
public class VueAjouterDocumentProc extends JFrame {
    ...
    private controleurEditDoc controleur;
    
    public VueAjouterDocumentProc(ControleurAddProc control, controleurEditDoc controleur) {
   ...
   private void listners() {
	   add.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			...
			{
				JOptionPane.showMessageDialog(null, "veuilez remlir les champs");
				return ;
			}
			if (controleur==null)
				control.documentajouter(libelleDoc.getText(),descriptionDoc.getText());
			else
				controleur.documentAjouter(libelleDoc.getText(),descriptionDoc.getText());
